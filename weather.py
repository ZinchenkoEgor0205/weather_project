...
"border: 0;")
        ...
        self.widget = QWidget(self.weather_detail_block)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(51, 21, 91, 29))
        self.horizontalLayout = QHBoxLayout(self.widget)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.weather_yandex = QLabel(self.widget)
        ...
        self.weather_yandex_data = QLabel(self.widget)
...
"enabled: true;")
        ...
        self.week_detail_block.setGeometry(QRect(10, -40, 961, 261))
        self.week_detail_block.setStyleSheet(u"background-color: #D9D9D9;\n"
"border: 0;")
        self.widget1 = QWidget(self.week_detail_block)
        self.widget1.setObjectName(u"widget1")
        self.widget1.setGeometry(QRect(170, 180, 781, 30))
        self.week_days_mailru = QHBoxLayout(self.widget1)
        self.week_days_mailru.setObjectName(u"week_days_mailru")
        self.week_days_mailru.setContentsMargins(0, 0, 0, 0)
        self.week_day_mailru = QLabel(self.widget1)
        ...
        self.week_days_mailru.addWidget(self.week_day_mailru)

        self.week_day_mailru_2 = QLabel(self.widget1)
        ...
        self.week_days_mailru.addWidget(self.week_day_mailru_2)

        self.week_day_mailru_3 = QLabel(self.widget1)
        ...
        self.week_days_mailru.addWidget(self.week_day_mailru_3)

        self.week_day_mailru_4 = QLabel(self.widget1)
        ...
        self.week_days_mailru.addWidget(self.week_day_mailru_4)

        self.week_day_mailru_5 = QLabel(self.widget1)
        ...
        self.week_days_mailru.addWidget(self.week_day_mailru_5)

        self.week_day_mailru_6 = QLabel(self.widget1)
        ...
        self.week_days_mailru.addWidget(self.week_day_mailru_6)

        self.week_day_mailru_7 = QLabel(self.widget1)
        ...
        self.week_days_mailru.addWidget(self.week_day_mailru_7)
        ...
        self.widget2 = QWidget(self.week_detail_block)
        self.widget2.setObjectName(u"widget2")
        self.widget2.setGeometry(QRect(170, 30, 781, 22))
        self.week_days = QHBoxLayout(self.widget2)
        self.week_days.setObjectName(u"week_days")
        self.week_days.setContentsMargins(0, 0, 0, 0)
        self.week_day = QLabel(self.widget2)
        ...
        self.widget3 = QWidget(self.week_detail_block)
        self.widget3.setObjectName(u"widget3")
        self.widget3.setGeometry(QRect(170, 100, 781, 30))
        self.week_days_yandex = QHBoxLayout(self.widget3)
        self.week_days_yandex.setObjectName(u"week_days_yandex")
        self.week_days_yandex.setContentsMargins(0, 0, 0, 0)
        self.week_day_yandex = QLabel(self.widget3)
        ...
        self.week_days_yandex.addWidget(self.week_day_yandex)

        self.week_day_yandex_2 = QLabel(self.widget3)
        ...
        self.week_days_yandex.addWidget(self.week_day_yandex_2)

        self.week_day_yandex_3 = QLabel(self.widget3)
        ...
        self.week_days_yandex.addWidget(self.week_day_yandex_3)

        self.week_day_yandex_4 = QLabel(self.widget3)
        ...
        self.week_days_yandex.addWidget(self.week_day_yandex_4)

        self.week_day_yandex_5 = QLabel(self.widget3)
        ...
        self.week_days_yandex.addWidget(self.week_day_yandex_5)

        self.week_day_yandex_6 = QLabel(self.widget3)
        ...
        self.week_days_yandex.addWidget(self.week_day_yandex_6)

        self.week_day_yandex_7 = QLabel(self.widget3)
        ...
        self.week_day_yandex.raise_()
        self.week_day_yandex_2.raise_()
        self.week_day_yandex_3.raise_()
        self.week_day_yandex_4.raise_()
        self.week_day_yandex_5.raise_()
        self.week_day_yandex_6.raise_()
        self.week_day_yandex_7.raise_()
        self.week_day_mailru.raise_()
        self.week_day_mailru_2.raise_()
        self.week_day_mailru_3.raise_()
        self.week_day_mailru_4.raise_()
